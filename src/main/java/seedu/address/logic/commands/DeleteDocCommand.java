...
public class DeleteDocCommand extends Command {
    ...
    public static final String COMMAND_WORD = "deldoc";
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof DeleteDocCommand)) {
            return false;
        }

        DeleteDocCommand otherDeleteDocCommand = (DeleteDocCommand) other;
        return targetIndex.equals(otherDeleteDocCommand.targetIndex);
    }
