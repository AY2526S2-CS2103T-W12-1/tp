...
public class EditPatCommandParser {
    ...
    public EditPatCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditPatCommand.MESSAGE_USAGE), pe);
        }
        ...
        parseTagsForEdit(argMultimap.getAllValues(PREFIX_TAG)).ifPresent(editPatDescriptor::setTags);
